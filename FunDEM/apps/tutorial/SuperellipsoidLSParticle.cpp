...
int main()
{
    ...
    const double3 boxMax = make_double3(l, l, 5. * l);
    ...
    solver_.addWall(BW.generateSurfacePointsUniform(), 
    ...
    5., 
    50, 
    "SuperellipsoidParticleFalling");

    solver_.moveWall(0, make_double3(0., 0., 10. * l));

    //solver_.addBondedParticleInteraction(1.e9, 0.3, 0.01);
    ...
    solver_.addWall(CW.generateSurfacePointsUniform(), 
    CW.gridInfo().gridNodeLevelSetFunctionValue, 
    CW.gridInfo().gridOrigin, 
    CW.gridInfo().gridNodeSize, 
    CW.gridInfo().gridNodeSpacing, 
    make_double3(0.5 * l, 0.5 * l, 0.5 * l), 
    make_quaternion(1., 0., 0., 0.), 
    6.e5, 
    1.8e5, 
    0.577);

    solver_.setFixedAngularVelocityToWall(1, make_double3(M_PI, 0., 0.));
    solver_.solve(make_double3(-l, -2. * l, -2. * l), 
    make_double3(2. * l, 3. * l, 3. * l), 
    make_double3(0., 0., -9.81), 
    1.e-4, 
    10., 
    100, 
    "SuperellipsoidParticleRolling");
}